...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOD, USER_GPIO_PD10_Pin|USER_GPIO_PD11_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : VBUS_SENSE_Pin PC3 PC6 PC8
                           PC9 PC10 PC11 PC12 */
  GPIO_InitStruct.Pin = VBUS_SENSE_Pin|GPIO_PIN_3|GPIO_PIN_6|GPIO_PIN_8
  ...
  /*Configure GPIO pins : USER_GPIO_PD10_Pin USER_GPIO_PD11_Pin */
  GPIO_InitStruct.Pin = USER_GPIO_PD10_Pin|USER_GPIO_PD11_Pin;
